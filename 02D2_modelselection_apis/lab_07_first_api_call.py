...
try:
    ...
    print("\n--- Conclusion ---")
print("This confirms a working end-to-end connection to a real LLM: the system")
print("prompt successfully constrained the AI to safe, non-diagnostic guidance,")
print("and the usage stats show the exact token cost of a single patient query —")
print("the foundation for estimating real-world cost at scale.")